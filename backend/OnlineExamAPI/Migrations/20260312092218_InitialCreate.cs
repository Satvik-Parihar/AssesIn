        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionSets_ExamPapers_ExamPaperId",
                        column: x => x.ExamPaperId,
                        principalTable: "ExamPapers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionSetItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionSetItems_QuestionSets_QuestionSetId",
                        column: x => x.QuestionSetId,
                        principalTable: "QuestionSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionSetItems_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAttempts_ExamPapers_ExamPaperId",
                        column: x => x.ExamPaperId,
                        principalTable: "ExamPapers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StudentAttempts_QuestionSets_QuestionSetId",
                        column: x => x.QuestionSetId,
                        principalTable: "QuestionSets",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionSetItems_QuestionId",
                table: "QuestionSetItems",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionSetItems_QuestionSetId",
                table: "QuestionSetItems",
                column: "QuestionSetId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionSets_ExamPaperId",
                table: "QuestionSets",
                column: "ExamPaperId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAttempts_ExamPaperId",
                table: "StudentAttempts",
                column: "ExamPaperId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentAttempts_QuestionSetId",
                table: "StudentAttempts",
                column: "QuestionSetId");
